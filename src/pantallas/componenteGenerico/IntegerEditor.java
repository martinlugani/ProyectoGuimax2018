...
public class IntegerEditor extends DefaultCellEditor {
	...
	protected boolean userSaysRevert() {
		...
		int answer = JOptionPane.showOptionDialog(SwingUtilities.getWindowAncestor(ftf),
				"El numero se debe encontrar entre" + minimum + " y " + maximum + ".\n" + "quieres continuar la edicion"
						+ "o volver a un número válido.",
				"Numero invalido", JOptionPane.YES_NO_OPTION, JOptionPane.ERROR_MESSAGE, null, options, options[1]);
	...
	public JFormattedTextField getTextFormater() {
		return ftf;
	}
